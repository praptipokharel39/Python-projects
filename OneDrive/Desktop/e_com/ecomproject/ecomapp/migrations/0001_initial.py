# Generated by Django 5.1.3 on 2025-03-21 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Order Received', 'Order Received'), ('Order Processing', 'Order Processing'), ('On the way ', 'On the way'), ('Order Completed', 'Order Completed'), ('Order Cancel', 'Order Cancel')], max_length=50)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
